...
page_shikigami_records.additional = [G.I_AD_DISAPPEAR, G.I_RECORDS_CLOSE, G.I_NEW_DLC_CLOSE]
...
page_mall.additional = [G.I_AD_CLOSE_RED, G.I_NEW_DLC_CLOSE, G.I_BACK_Y]
